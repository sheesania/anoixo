...
const useOverriddenButtonStyles = makeStyles({
  root: {
    ...
    backgroundImage:
      "url(\"data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='4' ry='4' stroke='%23333' stroke-width='2' stroke-dasharray='6%2c 14' stroke-dashoffset='0' stroke-linecap='square'/%3e%3c/svg%3e\")",
    backgroundClip: 'padding-box',
    borderRadius: '4px',
    border:
      '2px solid transparent' /* necessary to avoid contents jumping around when I add a border on hover */,
...
const AddWord: React.FC<Props> = memo((props: Props) => {
  ...
  return (
    <ButtonBase
      id={uid}
      classes={{ root: overriddenButtonStyle.root }}
      className="AddWord"
      component="div"
    ...
    >
      <Typography
        classes={{ subtitle1: overriddenTypographyStyle.subtitle1 }}
        variant="subtitle1"
        component="label"
        align="center"
        htmlFor={uid}
